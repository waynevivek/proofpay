    ...
    <main className="mx-auto max-w-6xl px-5 py-16 lg:px-8 lg:py-24">
      <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_.95fr] lg:gap-20">
        <div>
          ...
          <h1 className="display mt-8 max-w-lg">
            Sign in to keep the paper trail <em>honest.</em>
          </h1>
          <p className="mt-6 max-w-md text-lg leading-8 text-muted-foreground">
            Your checks, evidence, and drafted clarifications — right where you left them.
          </p>

          <div className="trust-row mt-11">
            <span>
              <LockKeyhole size={14} /> Your documents stay private
            </span>
            <span>
              <Zap size={14} /> Results in under 30 seconds
            </span>
          </div>
        </div>
        ...
        <div className="auth-card">
          ...
          <h2 className="mt-3 text-2xl font-semibold tracking-[-0.03em]">Welcome back</h2>
          ...
          <form onSubmit={handleSignIn} className="mt-7 flex flex-col gap-5">
            ...
            <Button type="submit" className="mt-1 h-12 w-full rounded-full">
